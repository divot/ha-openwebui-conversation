...
CONF_PERSISTENT_CHAT_ENABLED = "persistent_chat_enabled"
...
SEARCH_MODE_TRIGGER = "trigger"
SEARCH_MODE_NATIVE = "native"
SEARCH_MODES = (SEARCH_MODE_DISABLED, SEARCH_MODE_TRIGGER, SEARCH_MODE_NATIVE)
DEFAULT_SEARCH_MODE = SEARCH_MODE_DISABLED
...
DEFAULT_PERSISTENT_CHAT_ENABLED = False
